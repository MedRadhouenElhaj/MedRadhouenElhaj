# Mohamed Radhouen Elhaj

**iOS Consultant @ Jems Group | iOS Development, Swift**

�� Gennevilliers, Île-de-France, France &nbsp;|&nbsp; 📧 med.radhouen.elhaj@gmail.com &nbsp;|&nbsp; 📱 +33 745522764
🔗 [LinkedIn](https://www.linkedin.com/in/mohamedradhouenelhaj/) &nbsp;|&nbsp; 🐙 [GitHub](https://github.com/MedRadhouenElhaj) &nbsp;|&nbsp; 🐦 [X (Twitter)](https://twitter.com/ElhajRadhouen)

---

## 👤 About Me

Passionate about crafting high-performance and visually stunning iOS applications, I am an experienced iOS Developer with a focus on delivering seamless user experiences. My expertise spans various domains, including **Fintech**, **Ecommerce**, **IoT**, and **Social Media** apps.

**Key Strengths:**
- **Technical Proficiency:** Adept at leveraging the latest technologies and trends in iOS development to create robust and efficient applications.
- **Team Collaboration:** A dedicated team player thriving in collaborative environments and excelling under pressure, with experience in cross-functional teams.
- **Continuous Learner:** Committed to staying at the forefront of iOS development, actively seeking opportunities to learn and implement emerging techniques and technologies.
...
### Jems Group
**3 years 5 months** &nbsp;|&nbsp; Paris, Île-de-France, France
...
### Digit-U
**3 years 10 months** &nbsp;|&nbsp; Tunis, Tunisia
...
### Telecommunications Sector Training Center
...
**ESPRIT (Private College of Engineering and Technology)** &nbsp;|&nbsp; 2016 – 2019

### Fundamental License — Information Technology & Multimedia
**ISAMM (Institut Supérieur des Arts Multimédia de la Manouba)** &nbsp;|&nbsp; 2013 – 2016
...
|---|---|
| **Core** | SwiftUI, iOS Development, Swift |
| **Frameworks** | UIKit, Core Animation, AVFoundation, CoreImage, Metal, Firebase SDK, TwilioSDK |
| **Architecture** | Coordinator Pattern, Observer Pattern |
| **Web** | Angular, Node.js, Symfony, PHP, MySQL |
| **Tools** | Xcode, Git, GitFlow, GitLab, Postman, JIRA, Zeplin |
| **Project Management** | Scrum |
...
> 💬 *I'm always open to connecting with fellow professionals, sharing insights, and exploring potential collaborations. If you're passionate about iOS development, technology trends, or simply want to connect, feel free to reach out!*
